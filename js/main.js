document.addEventListener('DOMContentLoaded', () => {
  ...
  nav.addEventListener('click', () => {
    ...
    timeline2.set('.grid', { display: 'grid' })
      ...
      .to('.destination', 2, { autoAlpha: 1, y: -20, ease: Expo.easeOut }, '-=1.6');
  ...
  // let timeline2 = new TimelineMax();
  // timeline2.to('.forest img', 6, { y: -400, ease: Power2.easeIn }).to('.forest img', 6, { scale: 1.1 }, '-=6').to('.bg-image', 6, { y: -100 }, '-=6');
